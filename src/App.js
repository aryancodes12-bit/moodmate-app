...
const ResourcesView = () => {
    const resources = [{ type: 'video', title: '10-Minute Meditation For Stress', description: 'A guided meditation to help you find a sense of calm and peace.', link: 'https://www.youtube.com/watch?v=z6X5oEIg6Ak', thumbnail: 'https://placehold.co/600x400/a3e635/ffffff?text=Meditation' }, { type: 'video', title: 'How to make stress your friend', description: 'Psychologist Kelly McGonigal shares a new perspective on stress in this popular TED Talk.', link: 'https://www.youtube.com/watch?v=RcGyVTAoXEU', thumbnail: 'https://placehold.co/600x400/f87171/ffffff?text=TED+Talk' }, { type: 'pdf', title: 'Stress Management Techniques', description: 'A helpful guide from the University of Texas with practical strategies for managing stress.', link: 'https://cmhc.utexas.edu/stress.html', thumbnail: 'https://placehold.co/600x400/60a5fa/ffffff?text=Guide' }, { type: 'video', title: '5-Minute Breathing Exercise', description: 'A quick and effective breathing technique to calm anxiety and find your center.', link: 'https://www.youtube.com/watch?v=NpJm1I54hYc', thumbnail: 'https://placehold.co/600x400/f9a8d4/ffffff?text=Breathing' },];
                ...
                <nav className="container mx-auto px-4 sm:px-6 py-3 flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-2">
                        <div className="hidden sm:flex items-center space-x-1 bg-gray-200/80 dark:bg-gray-700/80 p-1 rounded-full">
                            <button onClick={() => setView('journal')} className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-all duration-300 ${view === 'journal' ? 'bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 shadow' : 'text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400'}`}>Journal</button>
                            <button onClick={() => setView('history')} className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-all duration-300 ${view === 'history' ? 'bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 shadow' : 'text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400'}`}>History</button>
                            <button onClick={() => setView('assessment')} className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-all duration-300 ${view === 'assessment' ? 'bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 shadow' : 'text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400'}`}>Assessment</button>
                            <button onClick={() => setView('anxiety-relief')} className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-all duration-300 ${view === 'anxiety-relief' ? 'bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 shadow' : 'text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400'}`}>Relief</button>
                            <button onClick={() => setView('resources')} className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-all duration-300 ${view === 'resources' ? 'bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 shadow' : 'text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400'}`}>Resources</button>
                            <button onClick={() => setView('feedback')} className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-all duration-300 ${view === 'feedback' ? 'bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 shadow' : 'text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400'}`}>Feedback</button>
                        </div>
